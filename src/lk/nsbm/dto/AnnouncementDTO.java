...
import lk.nsbm.entity.Job_Oppertunity;
...
public class AnnouncementDTO {
    ...
    public AnnouncementDTO(int _id, User user, Post post, WorkShop workShop, Job_Oppertunity job_oppertunity,
                           Announcement_Status announcement_status, String description, Date announced_date,
                           Date read_date, User announcement_abt) {
        this._id = _id;
        this.user = user;
        this.post = post;
