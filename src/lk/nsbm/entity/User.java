...
public class User {
    ...
    public User(String username, String password, Date dob, String details, Industry_Type industry, Country country, Date dateOfCreated, User_Type user_type, String user_profile_path, Date created_date, Date lastLoginDate, int loginAttempts) {
    ...
    public User(String username, String password, Date dob, String details, Industry_Type industry, Country country, Date dateOfCreated, User_Type user_type, String user_profile_path, User university, Date created_date, Date lastLoginDate, int loginAttempts) {
        this.username = username;
        this.password = password;
        this.dob = dob;
        this.details = details;
    ...
    @JsonSerialize(using = lk.nsbm.shared.ByteArraySerializer.class)
